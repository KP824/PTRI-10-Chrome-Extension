...
// MAIN FUNCTION FOR ALL FETCHES
function runAll () {
  // Fetch for background images
    fetch('https://api.unsplash.com/photos/random?client_id=4EIzmaDzCH3lbvkHUXeH_ceUEI1cMWkLWM3JIthy8xk&query=zen', {
      headers: {
          "Accept-Version": "v1"
      }
    })
  ...
  // randomize background image index
  const index = function() {
    return Math.floor(Math.random() * 50);
  }();
  
  // fetch call for gif's
  ...
  // Affirmation container assignment
